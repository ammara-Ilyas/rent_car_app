...
const Heading = ({ title, para }) => {
  return (
    <div className=" mx-auto font-medium   mb-10 text-white flex flex-col items-center justify-between">
      ...
      <h3 className="capitalize text-2xl sm:text-3xl lg:text-5xl font-sans   font-bold text-white bg-gradient-to-r from-pink-700 via-red-500 to-pink-700 text-transparent bg-clip-text">
        {title}
      </h3>
    </div>
  );
